...
def main(args):
    ...
    for file in tqdm(files):
        ...
        distance_mat_raw = instance_info['COST_MATRIX']
        edge_weight_type = instance_info.get('EDGE_WEIGHT_TYPE')
        distance_mat = np.array(distance_mat_raw) if distance_mat_raw else None
...
if __name__ == "__main__":
    ...
    parser.add_argument('--instance_path', type=str, default='/local/scratch/a/XXXX-1/vllm-carbon-XXXX-5/LLM-TSP-async/instances/tsplib_original', help='Path to the instance files')
